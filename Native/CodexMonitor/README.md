...
3. “全部会话”默认同时显示“工作台管理”“本机观察”和“历史档案”三类会话；左侧按项目归并。
4. 红色举手表示需要授权或补充信息，绿色举手表示完成未阅。
5. 单击卡片查看右侧工作单；点击卡片右下角图标，或点击工作单中的“在 Codex 中打开”，可直接跳到对应原生会话。
...
- `Tab` / `Shift-Tab`：在项目、筛选、职员卡和操作按钮之间移动焦点；`Return` / `Space` 执行当前控件。
- `⌘⇧A`：把当前项目的完成汇报标记为已阅。
- `⌘R`：刷新；`⌘⇧N`：交办任务。
